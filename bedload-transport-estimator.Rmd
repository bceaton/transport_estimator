...
```{r}
D50 <- 0.045 #enter the characteristic grain size for the sediment being transported

D_r <- 0.1  #enter the grain size that determines flow resistance, 
            #usually the 84th percentile of the bed surface

slope <- 0.01  #enter the reach average gradient for the stream in question (m/m)

Q <- 100  #enter the peak discharge to be assessed (m3/s)

Dur <- 6  #enter duration for the flow Q (hours)
```
